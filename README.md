...
* **NODE.JS - ELECTRON (HTML-CSS-JAVASCRIPT) :** <br/>
    ...
    * **ACTIVITIES :** <br/>
        * [ElectronJS Actividad Factura](https://github.com/chemacarceller/ElectronJS-Actividad-Factura) : <br />Desarrollo por fases de una actividad de gestión de facturas.<br />Fase 1 sin persistencia de datos (varias versiones) <br />Fase 2 con persistencia de datos en ficheros (versiones con modulos javascript import y modulos NodeJS require y version basada en Modelo-Vista-Controlador.<br />Fase 3 : Persistencia de datos en ficheros, MVC e implementación de canales de comunicación IPC e incorporación de menus y cajas de dialogos nativos.<br />Fase 4 : Persistencia de datos en BBDD relacionales (MySQL y SQLite) y No-SQL (MongoDB) con IPC, menus y caja de dialogos nativos + Modelo Vista Controlador extendido (con clases Services y clases Repositories), así como la utilización del modulo propio mongoTool en la versión MongoDB<br />Fase 5 : Versión análoga a la Fase 4 pero añadiendo un API de acceso a datos
  <!--
* UNREAL
     * UNREAL-ACTIVITIES :
     * UNREAL-DEMOS :
